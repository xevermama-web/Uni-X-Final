...
export default function StudentAttendanceAnalyticsView({ user, onClose, isModal = false }: StudentAttendanceAnalyticsViewProps) {
  ...
  const content = (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-slate-900 via-slate-800 to-indigo-950 text-white rounded-[24px] p-6 md:p-8 shadow-md relative overflow-hidden">
  ...
  if (isModal) {
    return (
      <div className="fixed inset-0 z-[9999] bg-slate-900/60 backdrop-blur-md flex items-center justify-center p-4 sm:p-6 overflow-y-auto animate-in fade-in duration-200">
        <div className="bg-slate-50 dark:bg-slate-800/70 w-full max-w-4xl max-h-[90vh] rounded-[32px] border border-slate-200 dark:border-slate-800 shadow-2xl overflow-y-auto p-6 md:p-8 relative my-auto">
          {/* Modal Header Bar */}
