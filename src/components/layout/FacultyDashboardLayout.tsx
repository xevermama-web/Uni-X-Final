  ...
  return (
    <div className="h-screen font-sans flex relative overflow-hidden bg-slate-50">
      ...
      <div className="flex-1 flex flex-col min-w-0 relative z-10 bg-[#f8fafc] dark:bg-slate-950">
        <header className="h-20 bg-white/40 dark:bg-slate-900/50 backdrop-blur-3xl border-b border-white/50 dark:border-white/10 flex items-center justify-between px-6 lg:px-8 sticky top-0 z-30 shadow-[0_4px_30px_rgba(0,0,0,0.03)] dark:shadow-[0_4px_30px_rgba(0,0,0,0.3)] relative before:absolute before:inset-x-0 before:top-0 before:h-[3px] before:bg-gradient-to-r before:from-cyan-400 before:via-blue-500 before:via-indigo-500 before:to-cyan-400 before:z-20 before:shadow-[0_0_12px_rgba(56,189,248,0.8)] after:absolute after:inset-x-0 after:top-[3px] after:h-[1px] after:bg-gradient-to-r after:from-transparent after:via-white/80 dark:after:via-white/20 after:to-transparent after:z-20">
