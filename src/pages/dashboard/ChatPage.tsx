...
export default function ChatPage() {
  ...
  return (
    <div className="h-[calc(100vh-8.5rem)] md:h-[calc(100vh-6rem)] max-h-[850px] flex flex-col font-sans bg-slate-50 dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden m-0 sm:m-4 md:m-6">
      {/* Top Header */}
