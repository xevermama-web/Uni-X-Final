      ...
      <div className="relative rounded-3xl overflow-hidden p-6 lg:p-8 bg-slate-900 text-white shadow-xl border border-slate-800">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          <div className="space-y-3 max-w-2xl">
            ...
            <h1 className="text-3xl lg:text-4xl font-black tracking-tight text-white drop-shadow-sm flex items-center gap-2">
        ...
        {stats.map((stat, i) => (
          ...
          >
            <div>
              ...
              <h3 className="text-3xl lg:text-4xl font-extrabold text-slate-900 dark:text-slate-100 mt-1 tracking-tight">{stat.value}</h3>
            </div>
        ...
        {selectedNotice && (
          ...
          >
            <motion.div 
              ...
              className="bg-white rounded-3xl shadow-2xl border border-slate-100 dark:border-slate-800 w-full max-w-lg p-6 max-h-[90vh] overflow-y-auto"
            >
