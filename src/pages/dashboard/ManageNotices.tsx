        ...
        {isAddModalOpen && (
          ...
          >
            <motion.div 
              ...
              className="bg-white dark:bg-slate-900/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/60 w-full max-w-lg p-6 max-h-[90vh] overflow-y-auto"
            >
        ...
        {selectedNoticeForView && (
          ...
          >
            <motion.div 
              ...
              exit={{ scale: 0.95, opacity: 0 }}
              onClick={(e) => e.stopPropagation()}
              className="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl border border-slate-100 dark:border-slate-800 w-full max-w-2xl p-6 sm:p-8 max-h-[90vh] overflow-y-auto"
            >
