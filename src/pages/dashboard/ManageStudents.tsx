        ...
        {isAddModalOpen && (
          ...
          >
            <motion.div 
              ...
              animate={{ scale: 1, opacity: 1 }}
              exit={{ scale: 0.95, opacity: 0 }}
              className="bg-white dark:bg-slate-900/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/60 w-full max-w-md p-5 sm:p-6 max-h-[90vh] overflow-y-auto"
            >
